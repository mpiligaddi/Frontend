...
const primaryColor = ['#F2692B', '#EF6326', '#FFC16A', '#DD6140'];
const warningColor = [
  '#ff9800',
  '#ffa726',
  '#fb8c00',
...
const boxShadow = {
  boxShadow:
    ...
    hexToRgb(blackColor) +
    ', 0.32), 0 4px 15px 0px rgba(' +
    hexToRgb(blackColor) +
    ', 0.10), 0 8px 5px -5px rgba(' +
    hexToRgb(blackColor) +
    ', 0.2)'
};
const primaryBackgroundText = {
...
const defaultBoxShadow = {
  ...
  boxShadow:
    '0 5px 9px -12px rgba(' +
    hexToRgb(blackColor) +
    ', 0.32), 0 3px 18px 0px rgba(' +
    hexToRgb(blackColor) +
    ', 0.10), 0 7px 8px -5px rgba(' +
    hexToRgb(blackColor) +
    ', 0.2)',
  padding: '8px 0',
